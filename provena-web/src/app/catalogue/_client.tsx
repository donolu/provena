...
export default function CataloguePage({
  ...
  initialProducts?: import('@/lib/api/types').PaginatedResponse<import('@/lib/api/types').Product>
}) {
  ...
  const { data: productsData, isPending: loadingProducts } = useQuery({
    ...
    initialData: Object.keys(productParams).length === 0 ? initialProducts : undefined,
  })
